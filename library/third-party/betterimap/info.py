...
# IMAP-клиент для людей. Является оберткой для стандартного imaplib.
# Для более удобного использования.

# документация и репозиторий:
# https://github.com/ikatson/betterimap#print-last-10-messages-in-the-mailbox-with-attachments
