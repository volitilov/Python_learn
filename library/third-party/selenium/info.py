...
br.find_element(By.LINK_TEXT, 'link_text')
br.find_element(By.PARTIAL_LINK_TEXT, 'partial_link_text')
br.find_element(By.NAME, 'name')
br.find_element(By.TAG_NAME, 'tag_name')
br.find_element(By.CLASS_NAME, 'class_name')
br.find_element(By.CSS_SELECTOR, 'css_selector')
...
# TODO: Объекты страницы
#		https://habrahabr.ru/post/273115/